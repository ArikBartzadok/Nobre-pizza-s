            ...
            <div class="container">
                <div class="row fullscreen d-flex align-items-center justify-content-center">
                    <div class="banner-content col-lg-10">
                        ...
                        <h5 class="text-white text-uppercase">Gerencie todos os feedbacks cadastrados</h5>                        
                    </div>											
                </div>
            </div>
        </section>		
                ...
                <div class="row d-flex justify-content-center">
                    <div class="menu-content pb-60 col-lg-10">
                        <div class="title text-center">
                            <h1 class="mb-10 text-white">Gerenciamento de feedbacks</h1>
                      ...
                      <?php
                        ...
                        <thead>
                          <tr>
                            ...
                            <th class="th-sm">ID do usuário
                            </th>
                            <th class="th-sm">Nota
                            </th>
                            <th class="th-sm">Comentário
                            </th>
                            <th class="th-sm">Ação
                            </th>
                          </tr>
                        ...
                        <tbody>
                      <?php do {?>
						            <td><?php echo $array['id_comentario'];?></td>
                        <td><?php echo $array['nome_cliente'];?></td>
							          <td><?php echo $array['id_cliente'];?></td>							          
							          <td><?php echo $array['nota'];?></td>
                        <td><?php echo $array['texto'];?></td>
							          
                        <td>                                                 
                          <a href="controller/excluir-feedback.php?id=<?php echo $array['id_comentario']?>">
